...
public class POSFrame extends javax.swing.JFrame {
    ...
    private void dibayarTextFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dibayarTextFieldActionPerformed
        ...
        try {
            ...
            String sql = String.format("INSERT INTO transaksi (total_harga, total_dibayar, kembalian) VALUES (%d, %d, %d)", totalBelanja, dibayar, kembalian);
            ...
            while (rs2.next())
            {
                idTransaksi = Math.max(idTransaksi, rs2.getInt("id_transaksi"));
            }
            
            var transaksi = new Transaksi();
            transaksi.id = idTransaksi;
            transaksi.totalHarga = totalBelanja;
            transaksi.totalDibayar = dibayar;
            ...
            for (int i = 0; i < totalBarang; i++) {
                ...
                String sql3 = String.format("INSERT INTO transaksi_barang (id_transaksi, kode, jumlah_barang) VALUES (%d, %s, %d)", idTransaksi, kodeBarang, jumlahBarang);
                stmt3.executeUpdate(sql3);
                transaksi.daftarBarang.put(Barang.getBarang(kodeBarang), jumlahBarang);
            }
            ...
            System.out.println("Total dibayar: " + transaksi.totalDibayar);
